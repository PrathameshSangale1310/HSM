        ...
        <>
            <div className='intro'>
                <div className='c-desc'>
                    <h2>LIVE YOUR DREAM AS A CAREER IN AUTOMOTIVE DIGITAL DESIGN + CLAY SCULPTING AND PROTOTYPING INTO A SUCCESSFUL PROFESSION BY TRAINING WITH US AT HSMDA.</h2>
                </div>
            </div>
        <div className='courses-container'>
            ...
            <div className='course-details'>
                <div className='course-detail'>
                    <div className="lv1">
                        <img src="/cmfoundation.jpeg" alt="Banner" className="course-img" />
                        {/* <div className="beginner">
                            <h1>LEVEL 1 - FOUNDATION</h1>
                        </div> */}
                    </div>

                    <div className='course-desc'>
                        <br />
                        <center><p><h4>LEVEL 1 - FOUNDATION</h4></p></center>
            ...
            <div className='course-details'>
                <div className='course-detail'>
                    ...
                    <div className='course-desc'>
                        <br />
                        <center><h4>LEVEL 2 - INTERMEDIATE</h4></center>
                        <center><h4>Fundamentals of Transportation Design</h4></center>
                        <center><p>Duration: 3 months, 4 hours/day</p>
                            <p>Fee: ₹90,000+GST</p></center>
                    </div>
